...
# Raise error if dnikit and dnikit_torch versions are out of sync
assert __version__ == dnikit.__version__, (
    f'dnikit_torch v{__version__} and dnikit v{dnikit.__version__} should be the same versions.'
)
